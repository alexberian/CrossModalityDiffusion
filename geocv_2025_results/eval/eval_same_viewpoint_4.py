...
# script for showing that having multiple sensors at the same viewpoint can improve the performance of GeNVS
...
def main(**kwargs):
    ...
    with torch.no_grad():
        for i in range(len(dataset)):
            # load data
            scene_data = dataset.get_images_same_input_viewpoint(i, input_domains=kwargs["input_domains"], target_domains=kwargs["target_domains"],
